...
/**
 * React hook die de Socket.io verbinding beheert en alle bot-events
 * accumuleert in een centrale state die door alle dashboard-pagina's
 * gedeeld kan worden via React Context.
 */
...
export interface BotState {
  ...
  // Filter breakdown voor pie chart
